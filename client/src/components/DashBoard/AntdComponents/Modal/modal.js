import { Button, Modal, Upload, Typography, Row, Col, Input, Image, Popconfirm, Rate, Form } from 'antd';
import {
  InboxOutlined,
  RollbackOutlined,
  EditOutlined,
...
export const AvailableBooksDetailsModal = (props) => {
  const { viewDetailsModal, setViewDetailsModal, setViewDetailsData, setViewDeatailsImg, viewDetailsData, viewDeatailsImg } = props;
        ...
        <Col xs={{ span: 24 }} md={{ span: 16 }}>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={viewDetailsData?.title} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.author} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.isbn} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={viewDetailsData?.assession} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.desc} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.publication} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 24 }} layout='vertical'>
              ...
              <TextArea rows={10} maxLength={3000} showCount placeholder='Enter abstract' value={viewDetailsData?.abstract} readOnly />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 16 }} layout='vertical'>
              ...
              <Input value={viewDetailsData?.location} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.genre} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <Row gutter={12}>
            ...
            <Col xs={{ span: 24 }} md={{ span: 16 }} layout='vertical'>
              ...
              <TextArea rows={3} maxLength={500} showCount placeholder='Enter Notes' value={viewDetailsData?.notes} readOnly />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }}>
...
export const BorrowedBooksViewDetailsModal = (props) => {
  ...
  return (
    <Modal
      ...
      footer={
        loginData.validUser.userType !== 'Student' && viewDetailsData?.status === 'Borrowed'
          ? [
              <Popconfirm
                placement='top'
          ...
          : loginData.validUser.userType !== 'Student' && viewDetailsData?.status === 'Lost'
          ? [
              <Popconfirm
                placement='top'
                title='Are you sure want to complete the process return?'
        ...
        <Col xs={{ span: 24 }} md={{ span: 16 }}>
          ...
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={viewDetailsData?.firstName} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.middleName} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.lastName} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.studentId} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.grade} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.section} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.email} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewDetailsData?.status} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={new Date(viewDetailsData?.dateBorrowed).toLocaleString()} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <h1
            style={{
...
export const ShelfProcessingModal = (props) => {
  ...
  return (
    <Modal
      ...
      footer={[
        <Button type='primary' icon={<EditOutlined />} hidden={processButton} onClick={onProcessProceed}>
          Process
        </Button>,
        ...
        bookResult && studentResult ? (
          <>
            <Button
              ...
              onClick={() => fetchBookData(bookResult) && fetchStudentData(studentResult) && onFinish()}
            >
              Validate
            </Button>
          </>
        ) : null,
        <Button icon={<RollbackOutlined />} type='primary' onClick={onCancelProcess}>
          Cancel
        </Button>,
      ]}
    >
          ...
          <Row gutter={12} style={{ marginBottom: '20px' }}>
            <Col xs={{ span: 24 }} md={{ span: 16 }} layout='vertical'>
              ...
              >
                ...
                <div id='reader-library' style={{ height: 400, width: 400 }}></div>
              </div>
            </Col>
    ...
    <Modal
      ...
      footer={[
        <Popconfirm
          placement='top'
          title={
            loginData.validUser.userType === 'Student' ? 'Are you sure want to remove this book?' : 'Are you sure want to reject this book?'
          }
        ...
        <Col xs={{ span: 24 }} md={{ span: 16 }}>
          ...
          <Row gutter={12}>
            ...
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={new Date(viewDetailsData?.dateReserved).toLocaleString()} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <h1
            style={{
...
export const InventoryAddBookModal = (props) => {
  ...
  return (
    <Modal
      ...
      footer={[
        <Button type='primary' icon={<RollbackOutlined />} key='cancel' onClick={() => setIsOpen(false)}>
          Cancel
        </Button>,
      ]}
    >
      ...
      >
        <Button icon={<FileAddOutlined />} type='primary' onClick={() => handleSingleModal()}>
          SINGLE ADD
        </Button>
        <Button icon={<FolderAddOutlined />} type='primary' onClick={() => handleBatchModal()}>
          BATCH ADD
        </Button>
      </div>
    </Modal>
...
export const InventoryBatchAddModal = (props) => {
  const { batchOpen, setBatchOpen, fileLists, handleFileUpload, handleFileRemove } = props;
  return (
    <Modal
      ...
      footer={[
        <Button type='primary' icon={<RollbackOutlined />} key='cancel' onClick={() => setBatchOpen(false)}>
          Cancel
        </Button>,
      ]}
    >
      ...
      >
        ...
        <p className='ant-upload-hint'>
          Support for a single upload. Strictly prohibited from uploading file not supported by the given format.
        </p>
      </Dragger>
    </Modal>
  );
...
export const InventoryLostBooksModal = (props) => {
  const { viewDetailsLostModal, setViewDetailsLostModal, setViewDetailsData, setViewDeatailsImg, viewDetailsData, viewDeatailsImg } = props;
  return (
    <Modal
      key='LostBookDetails'
        ...
        <Col xs={{ span: 24 }} md={{ span: 16 }}>
          ...
          <Row gutter={12}>
            ...
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={new Date(viewDetailsData?.dateLost).toLocaleString()} readOnly />
            </Col>
          </Row>
          <h1
            style={{
        ...
        <Col xs={{ span: 24 }} md={{ span: 16 }}>
          ...
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 24 }} layout='vertical'>
              ...
              <TextArea rows={10} maxLength={3000} showCount placeholder='Enter abstract' value={updateData?.abstract} readOnly />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 16 }} layout='vertical'>
          ...
          <Row gutter={12}>
            ...
            <Col xs={{ span: 24 }} md={{ span: 16 }} layout='vertical'>
              ...
              <TextArea rows={3} maxLength={500} showCount placeholder='Enter Notes' value={updateData?.notes} readOnly />
            </Col>
          </Row>
        </Col>
      </Row>
...
export const InventoryForReviewAddImageModal = (props) => {
  const { forReviewOpen, setForReviewOpen, handleFileUpdloadReview, imgprops, onPreview, form, onConfirmReview } = props;
  return (
    <Modal
      ...
      footer={[
        <Button type='primary' icon={<CheckOutlined />} key='cancel9' onClick={() => onConfirmReview()}>
          Confirm
        </Button>,
        <Button type='primary' icon={<RollbackOutlined />} key='cancel9' onClick={() => setForReviewOpen(false)}>
          Cancel
        </Button>,
      ]}
    >
...
export const LibrarianAccountDetailsModal = (props) => {
  const { viewLDetailsModal, setViewLDetailsModal, setViewLDetailsData, setViewLDeatailsImg, viewLDetailsData, viewLDeatailsImg } = props;
        ...
        <Col xs={{ span: 24 }} md={{ span: 16 }}>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={viewLDetailsData?.employeeId} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewLDetailsData?.firstName} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewLDetailsData?.middleName} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              ...
              <Input value={viewLDetailsData?.lastName} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewLDetailsData?.userType} readOnly style={{ borderRadius: '10px' }} />
            </Col>
            <Col xs={{ span: 24 }} md={{ span: 8 }} layout='vertical'>
              <Title
                level={5}
              ...
              <Input value={viewLDetailsData?.email} readOnly style={{ borderRadius: '10px' }} />
            </Col>
          </Row>
          <Row gutter={12}>
            <Col xs={{ span: 24 }} md={{ span: 8 }}>
...
export const AdminAccountDetailsModal = (props) => {
  const { viewADetailsModal, setViewADetailsModal, setViewADetailsData, setViewADeatailsImg, viewADetailsData, viewADeatailsImg } = props;
